      ...
      <div className="px-4 md:px-12 max-w-[100%] mx-auto">
        ...
        >
          ...
          <motion.div 
            ...
            whileHover={{ scale: 1.03, boxShadow: "0 10px 30px -15px rgba(168, 87, 255, 0.3)" }}
            transition={{ duration: 0.2 }}
          >
            <h3 className="text-2xl sm:text-3xl font-bold mb-2 text-[#a857ff]">91.3%</h3>
            <p className="text-xs sm:text-sm text-[#8e8888]">
              Cleavage efficiency on designed substrates, validated in vitro using novel substrate-profiling system
            </p>
          </motion.div>
          ...
          <motion.div 
            ...
            transition={{ duration: 0.2 }}
          >
            <h3 className="text-2xl sm:text-3xl font-bold mb-2 text-[#a857ff]">&gt;700M</h3>
            <p className="text-xs sm:text-sm text-[#8e8888]">
              Estimated number of patients globally affected by diseases involving undruggable or misfolded proteins
              (e.g., p53, Tau, α-synuclein)
            </p>
          </motion.div>
          ...
          <motion.div 
            ...
            transition={{ duration: 0.2 }}
          >
            <h3 className="text-2xl sm:text-3xl font-bold mb-2 text-[#a857ff]">$1.4 Trillion</h3>
            <p className="text-xs sm:text-sm text-[#8e8888]">
              Annual global healthcare cost burden from cancers and neurodegenerative disorders driven by toxic
          ...
          <motion.div 
            ...
            transition={{ duration: 0.2 }}
          >
            <h3 className="text-2xl sm:text-3xl font-bold mb-2 text-[#a857ff]">6–8 weeks</h3>
            <p className="text-xs sm:text-sm text-[#8e8888]">
              Average design-to-validation cycle for custom proteases, significantly faster than traditional drug
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          >
            ...
            >
              Proteins are the engines of cellular life, and dysfunction at this level fuels the deadliest illnesses. Yet
              most of today's therapies fail to target misfolded, disordered, or intracellular proteins due to their
              structural complexity and inaccessibility. ShinDAO leverages open-source tools, ML-guided design, and
              onchain funding to engineer custom proteases, precision biological tools that selectively destroy
            ...
            >
              ShinDAO's framework is built on programmable enzyme design validated in peer-reviewed research. Our
              protocols are governed onchain, our IP is transparent, and our impact compounds with every community-funded
              target. By decentralizing biotech R&D and enabling DAO-native scientific pipelines, ShinDAO redefines how
