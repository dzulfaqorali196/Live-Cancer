...
export default function HeroSection() {
  ...
  const scrollToHypothesis = (e: React.MouseEvent<HTMLButtonElement>) => {
    ...
    if (hypothesisSection) {
      ...
      const end = hypothesisSection.getBoundingClientRect().top + window.pageYOffset
        ...
        <div className="px-4 md:px-12 max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 items-start">
            ...
            <motion.div 
              ...
              className="bg-[#121212]/70 backdrop-blur-md rounded-3xl aspect-[4/3] flex items-center justify-center text-white text-lg md:text-xl font-medium overflow-hidden border border-white/10 shadow-lg"
              whileHover={{ scale: 1.02, boxShadow: "0 8px 30px -10px rgba(168, 87, 255, 0.3)" }}
              transition={{ duration: 0.3 }}
            >
              <motion.div
              ...
              >
                VIDEO OF <span className="text-[#a857ff] font-bold">shin</span><span className="text-[#a857ff] font-bold">DAO</span>
              </motion.div>
            </motion.div>
            ...
            >
              ...
              >
                ...
                >
                  <span className="text-[#a857ff]">Shin</span><span className="text-white">DAO</span>
                </motion.h1>
                ...
                >
                  ...
                  <div className="flex space-x-2">
                    ...
                    <motion.a
                      ...
                      title="Twitter/X"
                      whileHover={{ scale: 1.1, backgroundColor: "#a857ff]/80" }}
                      whileTap={{ scale: 0.95 }}
                    >
                      <FaXTwitter size={16} />
                    </motion.a>
              ...
              >
                ...
                >
                  ...
                  system. At <span className="text-[#a857ff] font-medium">ShinDAO</span>, we're pioneering decentralized cancer research by targeting IFI6 to unlock new
          ...
          >
            <motion.div 
              ...
              whileHover={{ scale: 1.01, boxShadow: "0 10px 40px -15px rgba(168, 87, 255, 0.3)" }}
              transition={{ duration: 0.3 }}
            >
              {/* Progress header */}
              <motion.div 
