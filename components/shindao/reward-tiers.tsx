...
export default function RewardTiers() {
  ...
  const cardGradients = [
    {
      ...
      radial: "radial-gradient(circle at 50% 0%, rgba(168, 87, 255, 0.3), transparent 70%)"
    },
    {
      active: "linear-gradient(135deg, rgba(31, 41, 55, 0.7), rgba(17, 24, 39, 0.9))",
      default: "linear-gradient(135deg, rgba(31, 41, 55, 0.6), rgba(17, 24, 39, 0.8))",
  ...
  return (
    <>
      <section 
        ref={sectionRef}
        className="relative text-white w-full py-12"
      >
        ...
        <div className="relative z-10">
          <div className="px-4 md:px-12 max-w-7xl mx-auto">
            <motion.div 
              ...
              style={{
                background: "linear-gradient(135deg, rgba(28, 28, 45, 0.9), rgba(20, 20, 43, 0.95))",
            ...
            >
              ...
              <motion.div 
                ...
                whileTap={{ scale: 0.98 }}
                style={{
                  background: "linear-gradient(90deg, rgba(168, 87, 255, 0.2), rgba(147, 69, 230, 0.3))",
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8 relative">
                ...
                >
                  ...
                  <div className="absolute -inset-[1px] rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                    style={{
                      background: "linear-gradient(to right, transparent, rgba(168, 87, 255, 0.3), transparent)",
                      filter: 'blur(1px)',
                    }}
                  />
                  ...
                  <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <div className="absolute inset-0 rounded-lg" style={{
                      background: "radial-gradient(circle at 50% 30%, rgba(168, 87, 255, 0.2) 0%, transparent 70%)"
                    }} />
                  </div>
                  ...
                  {/* Decorative Elements */}
                  <div className="absolute top-4 left-4 w-2 h-2 rounded-full transition-colors duration-300 opacity-0 group-hover:opacity-100" 
                    style={{ 
                      backgroundColor: "#a857ff",
                      boxShadow: "0 0 10px rgba(168, 87, 255, 0.4)"
                    }} 
                  />
                  <div className="absolute bottom-4 right-4 w-2 h-2 rounded-full transition-colors duration-300 opacity-0 group-hover:opacity-100" 
                    style={{ 
                      backgroundColor: "#a857ff",
                      boxShadow: "0 0 10px rgba(168, 87, 255, 0.4)"
                    }} 
      ...
      <motion.div 
        ...
        animate={isInView ? "visible" : "hidden"}
        style={{
          background: "linear-gradient(90deg, rgba(28, 28, 45, 0.9), rgba(20, 20, 43, 0.95))",
