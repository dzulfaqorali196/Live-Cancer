...
function MobileRoadmapCard({ item, index }: { item: RoadmapItem, index: number }) {
  ...
  return (
    ...
    >
      ...
      >
        <h3 className="text-xl font-bold text-center mb-2 text-[#a857ff]">{item.quarter}</h3>
      ...
      {isLeft ? (
        ...
        >
          <motion.div 
            ...
            whileHover={{ 
              scale: 1.03, 
              boxShadow: "0 10px 25px -5px rgba(168, 87, 255, 0.2), 0 10px 10px -5px rgba(168, 87, 255, 0.1)" 
            }}
          >
            <h3 className="text-2xl font-bold text-center mb-4 text-[#a857ff]">{item.quarter}</h3>
